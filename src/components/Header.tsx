      ...
      <header className={`header${scrolled ? " header--scrolled" : ""}`}>
        <div className="header__inner">
          <Link href="/" className="header__logo" onClick={closeAll}>
            <svg className="header__logo-icon" width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <div className="header__right">
            ...
            <Link href="/#contact-form" className="btn btn--primary header__cta" onClick={handleQuoteClick}>
              Get Free Quote
            </Link>
