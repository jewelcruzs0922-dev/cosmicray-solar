    ...
    <>
      ...
      <section className="contact-hero">
        <div className="contact-hero__inner" data-reveal>
          ...
          <p className="subheading">Ready to start saving with solar? We&apos;re here to help.</p>
        </div>
      </section>
        ...
        <div className="contact-content__inner">
          <div className="contact-form" data-reveal="left">
            ...
            {status === "sent" ? (
              <div className="contact-form__success">
                ...
                <h3>Message Sent!</h3>
                <p className="contact-form__success-text">Thank you for reaching out. We&apos;ll get back to you within 24 hours.</p>
              </div>
            ) : (
          ...
          <div className="contact-info" data-reveal="right">
            <div className="contact-info-card">
              ...
              <div className="contact-info-card__text"><h3>Phone</h3><p><a href={`tel:${PHONE_LINK}`}>{PHONE}</a></p></div>
            </div>
            <div className="contact-info-card">
              <div className="contact-info-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></div>
              <div className="contact-info-card__text"><h3>Email</h3><p><a href={`mailto:${EMAIL}`}>{EMAIL}</a></p></div>
            </div>
            <div className="contact-info-card">
              <div className="contact-info-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg></div>
              <div className="contact-info-card__text"><h3>Address</h3><p>{ADDRESS.street}<br />{ADDRESS.city}, {ADDRESS.state} {ADDRESS.zip}</p></div>
            </div>
            <div className="contact-info-card">
              ...
              <div className="contact-info-card__text"><h3>Hours</h3><p>Mon &ndash; Fri: 8AM &ndash; 6PM<br />Sat: 9AM &ndash; 2PM</p></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="contact-map">
        <div className="contact-map__inner" data-reveal>
          <div className="contact-map__placeholder"><span>{ADDRESS.full}</span></div>
        </div>
      </section>
