...
import { PHONE, PHONE_LINK, EMAIL, ADDRESS, SITE_NAME } from "@/lib/constants";
      ...
      <div className="footer__inner">
        <div className="footer__brand">
          <Link href="/" className="footer__logo">
            <svg className="footer__logo-icon" width="36" height="36" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <p>Powering homes with clean, renewable solar energy since 2012.</p>
        ...
        <div className="footer__links">
          ...
          <div>
            ...
            <ul>
              ...
              <li>{ADDRESS.street}<br />{ADDRESS.city}, {ADDRESS.state} {ADDRESS.zip}</li>
            </ul>
          </div>
        </div>
      </div>
