interface IconProps {
  name: "phone" | "email" | "location" | "clock" | "search" | "close" | "arrow-right" | "arrow-left" | "chevron-down" | "star" | "sun" | "bolt" | "battery" | "car" | "home" | "check" | "menu" | "cart" | "minus" | "plus" | "trash" | "external" | "linkedin" | "facebook" | "instagram" | "youtube";
  size?: number;
  className?: string;
}
...
export default function Icon({ name, size = 20, className }: IconProps) {
  ...
  switch (name) {
    ...
    case "battery":
      return <svg {...props}><rect x="1" y="6" width="18" height="12" rx="2" /><line x1="23" y1="13" x2="23" y2="11" /></svg>;
    case "car":
    ...
    case "instagram":
      return <svg {...props}><rect x="2" y="2" width="20" height="20" rx="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>;
    case "youtube":
      return <svg {...props}><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19.1c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.43z" /><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" /></svg>;
    default:
      return null;
  }
}
