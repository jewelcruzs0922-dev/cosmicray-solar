    ...
    <section className="reviews" aria-label="Google Reviews">
      <div className="reviews__inner">
        <div className="reviews__header">
          ...
          <h2 className="heading-xl">What Our Customers Say on Google</h2>
          <div className="reviews__overall">
            ...
            <span className="reviews__rating">{avgRating.toFixed(1)}</span>
        ...
        <div className="reviews__cta">
          <a
            href="https://www.google.com/search?q=cosmic+ray+solar+reviews"
