      ...
      <div className="results__inner">
        <div className="results__content">
          ...
          <div className="results__metrics">
            <div className="results__metric"><span className="results__metric-value">85%</span><span className="results__metric-label">Bill reduction</span></div>
          ...
          <a href="#contact-form" className="btn btn--accent btn--large">See My Savings &rarr;</a>
        </div>
