...
export const metadata: Metadata = generateBlogMetadata({
  ...
  ogTitle: "Charge Your EV With Solar: Complete Home Charging Guide | Cosmic Ray Solar",
  ogDescription:
...
export default function EVChargingGuidePage() {
  return (
    <BlogPostLayout
      slug="ev-charging-guide"
      title="Charge Your EV With Solar: Complete Home Charging Guide"
      description="Pair your solar system with an EV charger and drive on sunshine. We cover charger types, costs, installation, and how to maximize your savings."
      tag="EV Charging"
      date="2025-02-10"
      dateDisplay="February 10, 2025"
      readTime="9 min read"
      ogTitle="Charge Your EV With Solar: Complete Home Charging Guide | Cosmic Ray Solar"
      ogDescription="Complete guide to home EV charging — charger types, costs, installation, and how to maximize savings with solar."
      publishedTime="2025-02-10T08:00:00+00:00"
      modifiedTime="2026-08-01T08:00:00+00:00"
    >
      <p>
