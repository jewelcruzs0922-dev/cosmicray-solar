...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Solar Tax Credits 2025: How to Get 30% Off Your Installation | Cosmic Ray Solar",
    description:
    ...
    type: "article",
    url: "https://www.cosmicray.com/blog/solar-tax-credits",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Cosmic Ray Solar — Solar Tax Credits Guide",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://www.cosmicray.com/blog/solar-tax-credits",
  },
};
      ...
      <section className="post-hero">
        <div className="post-hero__inner">
          <div className="post-hero__meta">
            <span className="post-hero__tag">Savings</span>
          ...
          <p>
            A complete guide to the Federal Investment Tax Credit, state
            incentives, and how to claim every dollar you&apos;re entitled to when
            you go solar.
          </p>
        </div>
      </section>
      ...
      <section className="post-content">
        <div className="post-content__inner">
          ...
          <div className="post-cta">
            <h3>Claim Your 30% Solar Tax Credit</h3>
            <p>
              We&apos;ll help you size your system, calculate your incentive
              stack, and make sure you get every dollar you&apos;re entitled to
